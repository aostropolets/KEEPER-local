...
Cohorts for acute appendicitis (cases and controls) with subsequent sampling
...
DELETE FROM @target.cohort where cohort_definition_id = 651;
...
DELETE FROM @target.cohort where cohort_definition_id = 653;
INSERT INTO @target.cohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
